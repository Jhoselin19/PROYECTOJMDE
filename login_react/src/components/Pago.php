...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32"
        href="<?= base_url()?>/public/client/pago/assets/images/favicon-32x32.png">
    <title>FAMISALUD</title>
    <link rel="stylesheet" href="<?= base_url()?>/public/client/pago/assets/css/main.css">
    ...
    <main class="wrapper ">
        ...
        <div class="card">
            <div class="card-front">
                <img src="<?= base_url()?>/public/client/pago/assets/images/bg-card-front.png"
                    alt="Frente de la tarjeta">
                <div class="card-front__data">
                    <img src="<?= base_url()?>/public/client/pago/assets/images/card-logo.svg" alt="">
                    <div>
            ...
            <div class="card-back">
                <img src="<?= base_url()?>/public/client/pago/assets/images/bg-card-back.png" alt="Dorso de la tarjeta">
        ...
        <div class="form-wrapper">
            ...
            <div class="thank-you disabled" id="thank-you">
                <img src="<?= base_url()?>/public/client/pago/assets/images/icon-complete.svg"
